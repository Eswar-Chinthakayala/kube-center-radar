...
import { routePath, stripBasename } from './api/config'
      ...
      <div className="flex flex-col items-center gap-4 max-w-md text-center">
        ...
        <div>
          ...
          <p className="text-sm text-theme-text-secondary mt-2">
            Kube Center is configured with proxy authentication. Access it through your organization's auth proxy to authenticate.
          </p>
        </div>
      </div>
    </div>
...
// Header brand: emerald-square icon + "Kube Center" wordmark.
function Logo() {
  return (
    <div className="flex items-center gap-2.5">
      <div className="relative w-7 h-7 rounded-lg overflow-hidden flex-shrink-0 bg-emerald-500/10 border border-emerald-500/20">
        <img
          ...
          onError={(e) =>
            console.error('Kube Center logo asset failed to load:', (e.currentTarget as HTMLImageElement).src)
          }
        />
      </div>
